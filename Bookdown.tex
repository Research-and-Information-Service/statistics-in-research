...
This book is designed to provide readers with a brief introduction to statistics. It is not intended to act as a comprehensive course in statistics, it should however provide users with enough information to start using descriptive and inferential statistics to analyse data.
...
\[ |10 - 5| = 5,\]
\[ |7 - 9| = 2,\]
7-9 is equal to -2 but when we take the `absolute' value (\textbar7-9\textbar) we ignore the negative sign and report the result as 2.
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2258}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1935}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1613}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2097}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2097}}@{}}
