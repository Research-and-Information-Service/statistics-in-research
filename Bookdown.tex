...
The 95\% confidence bands were calculated using a technique called ``bootstrapping'' where the the original data set is resampled with replacement to create a larger number of new data sets allowing us to estimate the uncertainty in the fitted LOWESS curve and calculate confidence intervals. This is not the only way to calculate confidence intervals and there are pros and cons to different methods.
